...
class SessionRunnerFactory:
    ...
    def getRunner(self, model_dir, model_name, signature_key, input_labels, output_labels):
        ...
        return SessionRunner(sess, input_tensors, output_tensors)

def testSessionRunner():
    model_dir = "../models/lol/logistic_mnist_graph"
    model_name  = "logistic_mnist_graph"
    signature_key = "main_signature"
    input_labels = ["input"]
    output_labels = ["output"]
    runner = SessionRunnerFactory().getRunner(model_dir, model_name, signature_key, input_labels, output_labels)
